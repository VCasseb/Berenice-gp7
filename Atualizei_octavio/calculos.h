...
void realizar_venda(item *base,relatorio *rel, int tam)
{
    ...
    float total,total_vet[tam],total_parc,rcbd,troco;
    do
    {
        printf("|  \tCodigo\t  |  \tValor\t  |  \tEstoque\t  |  \tNome\t  |\n--------------------------------------------------------------------\n");
        for(int i=0; i<tam; i++)
        ...
        total_vet[i] = total_vet[i]+quantidade*base[i].valor_unitario;
        //total_vet[i] += total;
    }
    while(opc != 2);
    ...
    case 1:// a vista
        ...
        do{
            ...
            printf("Valor do produto com Desconto:%.2f", total);
    ...
    for(i=0; i<tam; i++)
    {
        ...
        printf("\t\tCodigo %d\n", rel[i].codigo);
        printf("\t\tNome %s\n", base[i].nome);
        printf("\t\tValor Total %.2f\n", rel[i].valor_unitario*rel[i].venda);
        printf("\t\tQuantidade %d\n", rel[i].venda);
